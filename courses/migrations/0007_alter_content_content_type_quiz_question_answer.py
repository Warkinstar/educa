    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_score_to_pass', models.IntegerField(verbose_name='Требуемый балл для прохождения теста')),
                ('difficulty', models.CharField(choices=[('easy', 'легкий'), ('medium', 'средний'), ('hard', 'сложный')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.quiz', verbose_name='questions')),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.question', verbose_name='answers')),
            ],
        ),
    ]
